          ...
          <div className="hidden md:block flex-1 max-w-[20rem] mx-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-100/50 rounded-full border border-gray-200 focus:bg-white focus:border-primary focus:outline-none placeholder:text-sm"
              />
            </div>
          </div>
