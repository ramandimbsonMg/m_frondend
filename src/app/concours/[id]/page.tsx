...
export default function ContestDetailPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 rounded-2xl p-8 text-white mb-8">
        <div className="flex flex-col md:flex-row md:items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-xl opacity-90 mb-6">{contest.tagline}</p>
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center">
                <Users className="w-5 h-5 mr-2" />
                <div>
                  <div className="text-2xl font-bold">{contest.stats.participants}</div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-2xl font-bold">{contest.stats.daysLeft}</div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-2xl font-bold">{contest.stats.projects}</div>
          ...
          <div className="mt-6 md:mt-0 md:ml-8">
            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6">
              <div className="text-sm mb-2">Organisé par</div>
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
                  <span className="text-purple-600 font-bold text-lg">{contest.organizer.logo}</span>
                </div>
                <div>
              ...
              <div className="text-sm mb-2">Sponsorisé par</div>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center">
                  <span className="text-white font-bold">{contest.sponsor.logo}</span>
                </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
            <div className="flex border-b border-gray-200 overflow-x-auto">
              {['overview', 'timeline', 'prizes', 'leaderboard', 'judges', 'resources'].map((tab) => (
                <button
                  key={tab}
            ...
            <div className="p-6">
              {activeTab === 'overview' && (
                <div className="space-y-8">
                  {/* Description */}
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Description du concours</h3>
                  ...
                  {/* Requirements */}
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Conditions de participation</h3>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-xl font-semibold text-gray-900">Progression du concours</h3>
                      <span className="font-bold text-purple-600">{contest.stats.completion}%</span>
                    </div>
              ...
              {activeTab === 'prizes' && (
                <div className="space-y-8">
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-2xl font-bold text-gray-900">#{prize.position}</div>
                          </div>
                        </div>
                        <div className="text-3xl font-bold text-gray-900 mb-4">{prize.amount}</div>
                  ...
                  <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl border border-cyan-100 p-6">
                    <h4 className="font-semibold text-gray-900 mb-4">🎁 Autres récompenses</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-center space-x-3 p-3 bg-white rounded-lg">
                        <Share2 className="w-5 h-5 text-blue-500" />
                        <div>
                          <div className="font-medium text-gray-900">Visibilité médiatique</div>
                          <div className="text-sm text-gray-600">Fonctionnalité dans notre newsletter</div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3 p-3 bg-white rounded-lg">
                        <TrendingUp className="w-5 h-5 text-green-500" />
                        <div>
                          <div className="font-medium text-gray-900">Boost de profil</div>
                          <div className="text-sm text-gray-600">Badge exclusif pendant 3 mois</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                    ...
                    {contest.leaderboard.slice(0, 3).map((entry) => (
                      ...
                      >
                        ...
                        <div className="text-center">
                          <div className="text-4xl font-bold text-gray-900 mb-2">#{entry.rank}</div>
                          <div className="font-bold text-gray-900 text-lg mb-2">{entry.name}</div>
                          <div className="flex items-center justify-center space-x-4 mb-4">
                            ...
                            <div className="text-center">
                              <div className="text-2xl font-bold text-gray-900">{entry.sales}</div>
                          ...
                          <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm ${
                            ...
                            {entry.change === 'up' && <TrendingUp className="w-3 h-3 mr-1" />}
                            {entry.change === 'down' && <TrendingUp className="w-3 h-3 mr-1 rotate-180" />}
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                      <h4 className="font-semibold text-gray-900">Classement complet</h4>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-gray-200">
                            <th className="py-3 px-6 text-left text-sm font-medium text-gray-600">Position</th>
                            <th className="py-3 px-6 text-left text-sm font-medium text-gray-600">Participant</th>
                            <th className="py-3 px-6 text-left text-sm font-medium text-gray-600">Score</th>
                            <th className="py-3 px-6 text-left text-sm font-medium text-gray-600">Ventes</th>
                            <th className="py-3 px-6 text-left text-sm font-medium text-gray-600">Tendance</th>
                          </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr key={entry.rank} className="border-b border-gray-100 hover:bg-gray-50">
                              ...
                              <td className="py-4 px-6">
                                <div className={`flex items-center ${
                                  ...
                                  {entry.change === 'up' && <TrendingUp className="w-4 h-4 mr-1" />}
                                  {entry.change === 'down' && <TrendingUp className="w-4 h-4 mr-1 rotate-180" />}
                                  {entry.change === 'new' && 'Nouveau'}
                                </div>
                              </td>
                            </tr>
          ...
          {/* Registration CTA */}
          {!isRegistered && (
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100 p-8 mb-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Prêt à participer ?</h3>
                  <p className="text-gray-700 mb-4">
                    Rejoignez {contest.stats.participants} entrepreneurs et tentez de remporter les prix
                  </p>
                ...
                <div className="mt-4 md:mt-0">
                  <button
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg font-bold hover:opacity-90"
                  >
        ...
        <div className="lg:w-80">
                  ...
                  <div className="flex-1">
                    ...
                    <div className={`text-xs mt-1 px-2 py-1 rounded-full inline-block ${
                      ...
                      {phase.status === 'active' ? 'En cours' :
                       phase.status === 'upcoming' ? 'À venir' : 'Terminé'}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div className="space-y-3">
              ...
              >
                ...
                <span>{isLiked ? 'Suivi' : 'Suivre ce concours'}</span>
              </button>
              <button className="w-full flex items-center justify-center space-x-2 py-3 border border-gray-300 rounded-lg hover:bg-gray-50">
                <Share2 className="w-5 h-5" />
                <span>Partager</span>
              </button>
              <button className="w-full flex items-center justify-center space-x-2 py-3 border border-gray-300 rounded-lg hover:bg-gray-50">
                <MessageCircle className="w-5 h-5" />
                <span>Forum du concours</span>
              </button>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-100 p-6">
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center justify-between p-3 bg-white/50 rounded-lg hover:bg-white">
                <div className="flex items-center space-x-3">
                  <FileText className="w-5 h-5 text-purple-500" />
                  <span className="text-sm text-gray-900">Guide du participant</span>
                </div>
              ...
              <a href="#" className="flex items-center justify-between p-3 bg-white/50 rounded-lg hover:bg-white">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-900">Webinaire d'introduction</span>
                </div>
                <ChevronRight className="w-4 h-4 text-gray-400" />
              </a>
              <a href="#" className="flex items-center justify-between p-3 bg-white/50 rounded-lg hover:bg-white">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-900">Template de soumission</span>
                </div>
                <ChevronRight className="w-4 h-4 text-gray-400" />
              </a>
            </div>
